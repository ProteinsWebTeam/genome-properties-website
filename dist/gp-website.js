var GenomePropertiesWebsite = (function () {
  ...
  var GenPropRenderer = function () {
    function GenPropRenderer() {
      _classCallCheck$1(this, GenPropRenderer);
    }

    _createClass$1(GenPropRenderer, [{
      key: 'renderGenProp',
  ...
  var ViewerRenderer = function () {
      function ViewerRenderer(github) {
          ...
          _classCallCheck$2(this, ViewerRenderer);

          this.github = github;
          this.options = options;
      }

      _createClass$2(ViewerRenderer, [{
          key: "getViewerHTML",
  ...
  var GenomePropertiesWebsite = function () {
    function GenomePropertiesWebsite(selector, options) {
      ...
      _classCallCheck$3(this, GenomePropertiesWebsite);
    ...
    _createClass$3(GenomePropertiesWebsite, [{
      key: "markup2html",
      value: function markup2html(txt) {
